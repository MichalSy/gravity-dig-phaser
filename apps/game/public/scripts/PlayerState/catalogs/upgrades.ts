...
export const UPGRADE_DEFINITIONS: Record<UpgradeId, UpgradeDefinition> = {
  ...
  ceiling_negotiator: {
    ...
    cost: { credits: 2200 }, prerequisites: ['micro_jetpack'], effects: [{ stat: 'jumpVelocity', op: 'multiply', value: 1.08 }, { stat: 'maxHealth', op: 'add', value: 10 }], tree: { x: -5, y: 5, branch: 'movement' },
  },
  turbo_snail: {
    ...
    cost: { credits: 3200 }, prerequisites: ['rocket_pants', 'ceiling_negotiator', 'xray_potato'], prerequisiteMode: 'any', effects: [{ stat: 'moveSpeed', op: 'multiply', value: 1.05 }, { stat: 'maxEnergy', op: 'add', value: 20 }], tree: { x: -6, y: 6, branch: 'movement' },
  },
  chrono_shoelaces: {
    ...
    cost: { credits: 4500 }, prerequisites: ['moonwalk_insurance', 'turbo_snail'], prerequisiteMode: 'any', effects: [{ stat: 'moveSpeed', op: 'multiply', value: 1.08 }, { stat: 'energyRegenPerSec', op: 'multiply', value: 1.1 }], tree: { x: -7, y: 7, branch: 'movement' },
  },
  bounce_tax_refund: {
    ...
    cost: { credits: 6200 }, prerequisites: ['ceiling_negotiator'], effects: [{ stat: 'jumpVelocity', op: 'multiply', value: 1.1 }, { stat: 'maxEnergy', op: 'add', value: 15 }], tree: { x: -8, y: 8, branch: 'movement' },
  },
  antigravity_sandwich: {
    ...
    cost: { credits: 8500 }, prerequisites: ['turbo_snail', 'bounce_tax_refund', 'unionized_nanobots'], prerequisiteMode: 'any', effects: [{ stat: 'airJumps', op: 'set', value: 3 }, { stat: 'gravityMultiplier', op: 'multiply', value: 0.82 }], tree: { x: -9, y: 9, branch: 'movement' },
  },
  panic_teleporter: {
    ...
    cost: { credits: 11000 }, prerequisites: ['chrono_shoelaces', 'antigravity_sandwich'], effects: [{ stat: 'moveSpeed', op: 'multiply', value: 1.12 }, { stat: 'maxEnergy', op: 'add', value: 25 }], tree: { x: -10, y: 10, branch: 'movement' },
  },
  comet_kneecaps: {
    ...
    cost: { credits: 14500 }, prerequisites: ['bounce_tax_refund'], effects: [{ stat: 'jumpVelocity', op: 'multiply', value: 1.12 }, { stat: 'gravityMultiplier', op: 'multiply', value: 0.9 }], tree: { x: -11, y: 11, branch: 'movement' },
  },
  quantum_hopscotch: {
    ...
    cost: { credits: 19000 }, prerequisites: ['antigravity_sandwich', 'comet_kneecaps'], effects: [{ stat: 'airJumps', op: 'set', value: 4 }, { stat: 'moveSpeed', op: 'multiply', value: 1.08 }], tree: { x: -12, y: 12, branch: 'movement' },
  },
  uninstall_gravity: {
    ...
    cost: { credits: 26000 }, prerequisites: ['panic_teleporter', 'quantum_hopscotch'], prerequisiteMode: 'any', effects: [{ stat: 'gravityMultiplier', op: 'multiply', value: 0.65 }, { stat: 'jumpVelocity', op: 'multiply', value: 1.12 }, { stat: 'maxEnergy', op: 'add', value: 50 }], tree: { x: -13, y: 13, branch: 'movement' },
  },
  spectrum_monocle: {
  ...
  copper_gossip: {
    ...
    cost: { credits: 2200 }, prerequisites: ['ore_scanner'], effects: [{ stat: 'oreScannerRadius', op: 'add', value: 2 }, { stat: 'pickupRadius', op: 'add', value: 20 }], tree: { x: 5, y: -5, branch: 'vision' },
  },
  fog_coupon: {
    ...
    cost: { credits: 3200 }, prerequisites: ['xray_potato', 'copper_gossip', 'storm_subscription'], prerequisiteMode: 'any', effects: [{ stat: 'sightRadius', op: 'add', value: 1 }, { stat: 'maxEnergy', op: 'add', value: 15 }], tree: { x: 6, y: -6, branch: 'vision' },
  },
  geology_karaoke: {
    ...
    cost: { credits: 4500 }, prerequisites: ['spectrum_monocle', 'fog_coupon'], prerequisiteMode: 'any', effects: [{ stat: 'oreScannerRadius', op: 'add', value: 2 }, { stat: 'energyRegenPerSec', op: 'multiply', value: 1.1 }], tree: { x: 7, y: -7, branch: 'vision' },
  },
  schrodinger_map: {
    id: 'schrodinger_map', label: "Schrödingers Karte", description: "Sicht +1 und Scanner +1. Das Erz ist da und nicht da.", category: 'visor',
    cost: { credits: 6200 }, prerequisites: ['copper_gossip'], effects: [{ stat: 'sightRadius', op: 'add', value: 1 }, { stat: 'oreScannerRadius', op: 'add', value: 1 }], tree: { x: 8, y: -8, branch: 'vision' },
  },
  bureaucratic_xray: {
    ...
    cost: { credits: 8500 }, prerequisites: ['fog_coupon', 'schrodinger_map', 'chrono_shoelaces'], prerequisiteMode: 'any', effects: [{ stat: 'oreScannerRadius', op: 'add', value: 3 }, { stat: 'maxHealth', op: 'add', value: 20 }], tree: { x: 9, y: -9, branch: 'vision' },
  },
  prophetic_breadcrumbs: {
    ...
    cost: { credits: 11000 }, prerequisites: ['geology_karaoke', 'bureaucratic_xray'], effects: [{ stat: 'sightRadius', op: 'add', value: 1 }, { stat: 'pickupRadius', op: 'add', value: 40 }], tree: { x: 10, y: -10, branch: 'vision' },
  },
  seismic_gossip: {
    ...
    cost: { credits: 14500 }, prerequisites: ['schrodinger_map'], effects: [{ stat: 'oreScannerRadius', op: 'add', value: 3 }, { stat: 'miningDamagePerSec', op: 'multiply', value: 1.08 }], tree: { x: 11, y: -11, branch: 'vision' },
  },
  omniscient_toaster: {
    ...
    cost: { credits: 19000 }, prerequisites: ['bureaucratic_xray', 'seismic_gossip'], effects: [{ stat: 'sightRadius', op: 'add', value: 1 }, { stat: 'maxEnergy', op: 'add', value: 40 }, { stat: 'energyRegenPerSec', op: 'multiply', value: 1.1 }], tree: { x: 12, y: -12, branch: 'vision' },
  },
  privacy_abolished: {
    ...
    cost: { credits: 26000 }, prerequisites: ['prophetic_breadcrumbs', 'omniscient_toaster'], prerequisiteMode: 'any', effects: [{ stat: 'sightRadius', op: 'add', value: 2 }, { stat: 'oreScannerRadius', op: 'add', value: 4 }, { stat: 'pickupRadius', op: 'add', value: 80 }], tree: { x: 13, y: -13, branch: 'vision' },
  },
  arc_apprentice: {
  ...
  ore_blender: {
    ...
    cost: { credits: 2400 }, prerequisites: ['chain_lightning'], effects: [{ stat: 'miningDamagePerSec', op: 'multiply', value: 1.12 }, { stat: 'energyCostPerSec', op: 'multiply', value: 0.93 }], tree: { x: 5, y: 5, branch: 'mining' },
  },
  laser_spaghetti: {
    ...
    cost: { credits: 3500 }, prerequisites: ['storm_subscription', 'ore_blender', 'rubber_duck_protocol'], prerequisiteMode: 'any', effects: [{ stat: 'miningRange', op: 'add', value: TILE_SIZE * 2 }], tree: { x: 6, y: 6, branch: 'mining' },
  },
  thunder_ferret: {
    ...
    cost: { credits: 5000 }, prerequisites: ['arc_apprentice', 'laser_spaghetti'], prerequisiteMode: 'any', effects: [{ stat: 'chainMiningTargets', op: 'set', value: 6 }, { stat: 'pickupRadius', op: 'add', value: 30 }], tree: { x: 7, y: 7, branch: 'mining' },
  },
  tax_evasion_drill: {
    ...
    cost: { credits: 7000 }, prerequisites: ['ore_blender'], effects: [{ stat: 'miningDamagePerSec', op: 'multiply', value: 1.15 }, { stat: 'cargoStackLimit', op: 'add', value: 2 }], tree: { x: 8, y: 8, branch: 'mining' },
  },
  plasma_fondue: {
    ...
    cost: { credits: 9500 }, prerequisites: ['laser_spaghetti', 'tax_evasion_drill', 'unionized_nanobots'], prerequisiteMode: 'any', effects: [{ stat: 'miningDamagePerSec', op: 'multiply', value: 1.15 }, { stat: 'miningRange', op: 'add', value: TILE_SIZE }], tree: { x: 9, y: 9, branch: 'mining' },
  },
  recursive_pickaxe: {
    ...
    cost: { credits: 12500 }, prerequisites: ['thunder_ferret', 'plasma_fondue'], effects: [{ stat: 'chainMiningTargets', op: 'set', value: 8 }, { stat: 'miningDamagePerSec', op: 'multiply', value: 1.1 }], tree: { x: 10, y: 10, branch: 'mining' },
  },
  caffeinated_beam: {
    ...
    cost: { credits: 16500 }, prerequisites: ['tax_evasion_drill'], effects: [{ stat: 'miningDamagePerSec', op: 'multiply', value: 1.2 }, { stat: 'energyCostPerSec', op: 'multiply', value: 0.9 }, { stat: 'moveSpeed', op: 'multiply', value: 1.05 }], tree: { x: 11, y: 11, branch: 'mining' },
  },
  localized_apocalypse: {
    ...
    cost: { credits: 21500 }, prerequisites: ['plasma_fondue', 'caffeinated_beam'], effects: [{ stat: 'chainMiningTargets', op: 'set', value: 10 }, { stat: 'miningRange', op: 'add', value: TILE_SIZE * 2 }, { stat: 'maxEnergy', op: 'add', value: 30 }], tree: { x: 12, y: 12, branch: 'mining' },
  },
  planetary_unsubscribe: {
    ...
    cost: { credits: 30000 }, prerequisites: ['recursive_pickaxe', 'localized_apocalypse'], prerequisiteMode: 'any', effects: [{ stat: 'miningDamagePerSec', op: 'multiply', value: 1.35 }, { stat: 'chainMiningTargets', op: 'set', value: 12 }, { stat: 'energyCostPerSec', op: 'multiply', value: 0.8 }], tree: { x: 13, y: 13, branch: 'mining' },
  },
  emergency_banana: {
  ...
  cargo_origami: {
    ...
    cost: { credits: 2300 }, prerequisites: ['pocket_wormhole'], effects: [{ stat: 'cargoStackLimit', op: 'add', value: 4 }, { stat: 'cargoSlots', op: 'add', value: 1 }], tree: { x: -5, y: -5, branch: 'utility' },
  },
  pocket_dimension: {
    ...
    cost: { credits: 3400 }, prerequisites: ['rubber_duck_protocol', 'cargo_origami', 'rocket_pants'], prerequisiteMode: 'any', effects: [{ stat: 'pickupRadius', op: 'add', value: 60 }, { stat: 'cargoStackLimit', op: 'add', value: 3 }], tree: { x: -6, y: -6, branch: 'utility' },
  },
  unionized_nanobots: {
    ...
    cost: { credits: 4800 }, prerequisites: ['emergency_banana', 'pocket_dimension'], prerequisiteMode: 'any', effects: [{ stat: 'energyRegenPerSec', op: 'multiply', value: 1.25 }, { stat: 'maxHealth', op: 'add', value: 20 }], tree: { x: -7, y: -7, branch: 'utility' },
  },
  loot_boomerang: {
    ...
    cost: { credits: 6700 }, prerequisites: ['cargo_origami'], effects: [{ stat: 'pickupRadius', op: 'add', value: 80 }, { stat: 'miningRange', op: 'add', value: TILE_SIZE }], tree: { x: -8, y: -8, branch: 'utility' },
  },
  insurance_fraud: {
    ...
    cost: { credits: 9000 }, prerequisites: ['pocket_dimension', 'loot_boomerang', 'thunder_ferret'], prerequisiteMode: 'any', effects: [{ stat: 'maxHealth', op: 'add', value: 30 }, { stat: 'maxEnergy', op: 'add', value: 30 }], tree: { x: -9, y: -9, branch: 'utility' },
  },
  portable_shipyard: {
    ...
    cost: { credits: 12000 }, prerequisites: ['unionized_nanobots', 'insurance_fraud'], effects: [{ stat: 'energyRegenPerSec', op: 'add', value: 5 }, { stat: 'cargoSlots', op: 'add', value: 1 }], tree: { x: -10, y: -10, branch: 'utility' },
  },
  cosmic_vacuum: {
    ...
    cost: { credits: 16000 }, prerequisites: ['loot_boomerang'], effects: [{ stat: 'pickupRadius', op: 'set', value: 400 }, { stat: 'cargoStackLimit', op: 'add', value: 5 }], tree: { x: -11, y: -11, branch: 'utility' },
  },
  administrative_immortality: {
    ...
    cost: { credits: 21000 }, prerequisites: ['insurance_fraud', 'cosmic_vacuum'], effects: [{ stat: 'maxHealth', op: 'add', value: 50 }, { stat: 'maxEnergy', op: 'add', value: 50 }, { stat: 'gravityMultiplier', op: 'multiply', value: 0.92 }], tree: { x: -12, y: -12, branch: 'utility' },
  },
  reality_premium: {
    ...
    cost: { credits: 30000 }, prerequisites: ['portable_shipyard', 'administrative_immortality'], prerequisiteMode: 'any', effects: [{ stat: 'maxHealth', op: 'add', value: 75 }, { stat: 'maxEnergy', op: 'add', value: 75 }, { stat: 'miningDamagePerSec', op: 'multiply', value: 1.15 }, { stat: 'moveSpeed', op: 'multiply', value: 1.1 }, { stat: 'sightRadius', op: 'add', value: 1 }, { stat: 'pickupRadius', op: 'add', value: 100 }], tree: { x: -13, y: -13, branch: 'utility' },
  },
  laser_mk2: {
    id: 'laser_mk2',
    label: 'Laser MK2',
